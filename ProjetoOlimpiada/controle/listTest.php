                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $list = $testDAO->listTestsByCompetition($id);
                                            foreach ($list as $row) {
                                                print "<tr><td>".$row['classification']."</td><td>".$row['start_date']."</td><td><a href='editTestForm.php?id="
                                                        .$row['id']."'>Editar</a></td><td><a href='removeTest.php?id=".$row['id']."'>Remover</td></tr>";
                                            }
                                        ?> 
                                    </tbody>
                                </table>
