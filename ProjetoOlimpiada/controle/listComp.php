                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $list = $compDAO->listCompetitions();
                                            foreach ($list as $row) {
                                                //print "<tr><td>".$row['name']."</td><td>".date('d/m/Y H:i', strtotime($row['start_date']))."</td><td><a href='editCompForm.php?id=".$row['id']."'>Editar</a></td><td><a href='listTest.php?id=".$row['id']."'>"
                                                   //     ."Manter Prova</a></td><td><a href='removeComp.php?id=".$row['id']."'>Remover</td></tr>";
                                                print "<tr><td><a href='listTest.php?id=".$row['id']."'>".$row['name']."</a></td><td>".date('d/m/Y', strtotime($row['start_date']))."</td><td><a href='editCompForm.php?id=".$row['id']."'>Editar</a></td><td><a href='removeComp.php?id=".$row['id']."'>Remover</td></tr>";
                                            }
                                        ?> 
                                    </tbody>
                                </table>
