...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            <div class="row">
                <div class="col-lg-12"><a href="../painelControle.php">Painel de Controle</a>->Ver Administratores</div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list as $admin) {
                                                print "<tr>"
                                                        ...
                                                        . "<td>"
                                                        . "<a href='editAdminForm.php?id=" . $admin->getId() . "'>Editar</a>"
                                                        . "</td>"
                                                        . "<td>"
                                                        . "<a href='removeAdmin.php?id=" . $admin->getId() . "'>Remover</a>"
                                                        . "</td>"
                                                        . "</tr>";
                                            }
                                            ?> 
